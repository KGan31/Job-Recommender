...
function Form() {
  ...
  const handleProjChange = (index, field, value) => {
    ...
    setEditedDetails({ ...editedDetails, projects: updateProj });
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("http://localhost:5000/api/save-profile", editedDetails);
            ...
            <Grid container spacing={2}>
              {editedDetails.education.map((e, index) => (
                <>
                  ...
                  <Grid item xs={6}>
                    <SoftTypography variant="h6" fontWeight="regular" style={{ marginTop: "1px" }}>
                      University/College
                    </SoftTypography>
                    <SoftInput
                      size="medium"
                      value={e.university}
                      onChange={(ev) => handleEducationChange(index, "university", ev.target.value)}
                    ></SoftInput>
                  </Grid>
                  <Grid item xs={6}>
                    <SoftTypography variant="h6" fontWeight="regular">
                    ...
                    <SoftInput
                      size="medium"
                      value={e.degree}
                      onChange={(ev) => handleEducationChange(index, "degree", ev.target.value)}
                    ></SoftInput>
                  </Grid>
                  <Grid item xs={6}>
                    <SoftTypography variant="h6" fontWeight="regular">
                    ...
                    <SoftInput
                      size="medium"
                      value={e.location}
                      onChange={(ev) => handleEducationChange(index, "location", ev.target.value)}
                    ></SoftInput>
                  </Grid>
                  <Grid item xs={6}>
                    <SoftTypography variant="h6" fontWeight="regular">
                ...
                <>
                  ...
                  <Grid item xs={6}>
                    ...
                    <SoftInput
                      ...
                      onChange={(ev) => handleExpChange(index, "company_name", ev.target.value)}
                    ></SoftInput>
                  </Grid>
                  <Grid item xs={6}>
                    <SoftTypography variant="h6" fontWeight="regular">
                ...
                <>
                  ...
                  <Grid item xs={9}>
                    ...
                    <textarea
                      ...
                      onChange={(ev) => handleProjChange(index, "description", ev.target.value)}
                    ></textarea>
                  </Grid>
                </>
              ))}
